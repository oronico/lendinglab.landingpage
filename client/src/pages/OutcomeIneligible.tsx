          ...
          <Card className="shadow-lg border-0" data-testid="screen-ineligible">
            <CardContent className="pt-12 pb-12 text-center space-y-6">
              ...
              <div className="pt-4 space-y-3">
                <div className="bg-orange-500/5 border border-orange-500/20 rounded-lg p-5 max-w-lg mx-auto text-left">
                  <p className="text-sm text-muted-foreground mb-3">
                    Not ready yet? We're building <a href="https://schoolstack.ai/?ref=lendinglab&outcome=ineligible" target="_blank" rel="noreferrer" className="text-orange-500 hover:underline font-medium">SchoolStack.ai</a> to help early-stage schools like yours build the foundation you need. Coming soon.
                  </p>
                  <a
